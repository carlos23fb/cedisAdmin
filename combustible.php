...
$(document).ready(function() {
   ...
   $('#btnAgregarnuevo').click(function(){
      ...
      $.ajax({
         type:"POST",
         data:datos,
         url:"procesos/registrar_combustible.php",
         success:function(r){
            if(r==1){
               $('#frmnuevo')[0].reset();
               $('#tablaDatatable').load('tabla_combustible.php');
               alertify.success("Registro de com  agregado con exito");

            }else{
               alertify.error("Fallo al agregar el combustible");
            }
         }
      });
   });
